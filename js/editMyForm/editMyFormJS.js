...
editMyForm.getForm = function(params) {
	...
	$(".testHTML").trigger("editMyForm.formCreated");
...
editMyForm.mapSelectParams = function(inputParamsElement) {
	...
	console.log("inputParamsElement BEGIN");
	console.log(JSON.stringify(inputParamsElement));

	var selectParams = {};

	selectParams.id = inputParamsElement.inputId;
	selectParams.placeholder = inputParamsElement.placeholder;
	selectParams.selectClass = inputParamsElement.selectClass;
...
editMyForm.getFormGroupInputElement = function(formTypeInt, inputElementParams) {
	...
	console.log("inputElementParams.elementType==========>" + inputElementParams.elementType); // leabve
	// this

	console.log(JSON.stringify(inputElementParams));
	...
	switch (inputElementParams.elementType) {
		...
		case "select":
			...
			console.log("JSON.tringify=====>" + JSON.stringify(inputElementParams));
			// (placeholder, selectClass, multiple, options, optgroups)
			return editMyForm.getFormGroupSelect(formTypeInt, editMyForm.mapSelectParams(inputElementParams));
			break;
		case "input":// done
		default:
...
editMyForm.getFormGroupInputDivBefore = function(formTypeInt, inputColumns) {
	...
	console.log("getFormGroupInputDivBefore");
 ...
 * @param optgroups
 */
editMyForm.getFormGroupSelect = function(formTypeInt, selectParams) {

	console.log("getFormGroupSelect===========> BEGIN");

	console.log(JSON.stringify(selectParams));
	console.log(formTypeInt);
	console.log("getFormGroupSelect===========> END"+ htmlTemplateSelect);
	...
	console.log("getFormGroupSelect===========> OUTR");
	
	$(".testHTML").on("editMyForm.formCreated", function() {
...
editMyForm.getFormGroupSelectOptions = function(options, optgroups) {
	...
	console.log("getFormGroupSelectOptions BEGIN");
	
	console.log(options);
	console.log("OPTG===>"+JSON.stringify(optgroups));
	...
	if (!!optgroups) {
		if (!!options) {
			 ...
			 console.log("OPTIONS AND OPTGROUPS=====>");
			var firstOptgroup = {};
			firstOptgroup.label = '';
			...
			console.log("NO OPTIONS BUT  OPTGROUPS= _YES====>");
			
		}
		console.log("getOptGroup to be iterated==>" + JSON.stringify(optgroups));
		
		
		$.each(optgroups, function(index, value) {
			
		
			console.log("getOptGroup  PARAMSSS===>"+value);
			
			optionsHtml += editMyForm.getOptGroup(value.label, value.disable, value.options);
		});
	...
	console.log("getFormGroupSelectOptions END======>"+optionsHtml);
	return optionsHtml;
 ...
 */
editMyForm.getOptGroup = function(label, disable, options) {
	
	console.log("GE IN OPTGROUPS");
	...
	$.each(options, function(index, value) {
		...
		console.log("GE IN OPTGROUPS OPTIONS");
